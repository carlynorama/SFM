...
const char endByte = '\n';    //10
const char trueByte = 'T';    
const char falseByte = 'F';   
const char thwacker0Byte = '0'; //48 //49
const char thwacker1Byte = '1';
const char thwacker2Byte = '2';
const char thwacker3Byte = '3';
//number of thwakers
...
void loop() {
  ...
  if (manualModeFlag == 0) {
    ...
    case  thwacker0Byte:
        thwack(thwackPinArray[0]);
      break;
        
    case  thwacker1Byte:
        thwack(thwackPinArray[1]);
      break;
    
    case  thwacker2Byte:
        thwack(thwackPinArray[2]);
      break;  
    
    case  thwacker3Byte:
        thwack(thwackPinArray[3]);
      break;
