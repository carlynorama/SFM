...
void setup() {
  ...
  //DDRD = DDRD | B11111100;
  //above depricated...
  pinMode(sensorsEnablePin, OUTPUT);
...
/*when doing a port of enable pins
...
void pulseSensorEnable() {
  //enable by setting entire register high for 20 us
  digitalWrite(sensorsEnablePin, HIGH); 
  delayMicroseconds(20);
  digitalWrite(sensorsEnablePin, LOW);
}
